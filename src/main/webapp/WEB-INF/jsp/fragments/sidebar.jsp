...
<aside class="dashboard-sidebar d-flex flex-column vh-100 shadow-lg bg-light">
            ...
            <c:forEach var="module" items="${defaultModules}">
                <li>
                    <a href="${pageContext.request.contextPath}${module.link}"
                       class="sidebar-link d-flex align-items-center px-3 py-2 rounded ${currentPage eq module.id ? 'active' : ''}">
