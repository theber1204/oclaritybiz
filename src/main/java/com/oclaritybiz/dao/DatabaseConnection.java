...
public class DatabaseConnection {
    ...
    private static final String DB_USER = "theber";       // Cambia este valor si usas otro usuario
    private static final String DB_PASS = "theber_password";  // Sustituye por la contraseña real
